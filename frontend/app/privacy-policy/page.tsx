  ...
  const faqs = [
    {
      ...
      answer:
        "No, never. We don't sell your personal information to anyone. Your data is yours, and we only use it to make NovaLabs work better for you.",
    },
    {
    ...
    <div className="min-h-screen bg-[#faf9f7]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  We collect information to run NovaLabs and make it useful for
          ...
          <div className="p-8 md:p-12 space-y-12">
            ...
            <section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">
                    When you use NovaLabs, we collect:
                  </h3>
                  <div className="bg-[#faf9f7] rounded-lg p-6 space-y-2">
                    <p className="text-gray-700">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed mb-6">
                ...
                limited information with trusted partners to make NovaLabs
                work:
              </p>
        ...
        <div className="mt-12 bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white text-center">
          ...
          <a
            href="mailto:privacy@novalabs.com"
