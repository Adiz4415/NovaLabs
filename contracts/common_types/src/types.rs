//! Common types used across NovaLabs contracts.
//!
//! This module provides shared enums and structs to ensure consistency
//! across all NovaLabs smart contracts, including subscription management,
...
/// Subscription plan types available in NovaLabs.
///
...
/// User role types in the NovaLabs system.
///
...
/// Includes all status variants used across NovaLabs contracts.
///
/// # Variants
